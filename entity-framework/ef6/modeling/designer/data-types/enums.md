...
6.  El Asistente para crear bases de datos hace lo siguiente: Abre **EnumTest. edmx. SQL** en el editor de T-SQL genera las secciones de asignación y esquema del almacén del archivo edmx agrega información de la cadena de conexión al archivo app. config.
