...
---
# <a name="entity-framework-6-runtime-license-kor"></a>Licencia de en tiempo de ejecución de Entity Framework 6 (KOR)
...
-   **a. 미국.** 소프트웨어를 미국에서 구입한 경우, 원칙에 국제사법 관계없이 계약의 본 해석은 주법을 워싱턴 따르며 위반에 계약 대한 발생 청구 시에도 주법이 워싱턴 적용됩니다. 소비자 보호법, 및 불공정거래법 기타 행위 불법 관련 적용을 법규의 받는 발생한 청구가 경우 거주하고 귀하가 있는 주법이 주의 적용됩니다.
...
**오스트레일리아의 경우 – 오스트레일리아 귀하는 소비자 따라 보호법에 법적 보유하며 권리를 본 어떠한 계약서의 내용도 권리에 해당 영향을 수 미칠 없습니다.**
