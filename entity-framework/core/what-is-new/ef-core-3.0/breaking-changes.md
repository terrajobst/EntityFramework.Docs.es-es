...
`RelationalEventId.LogQueryPossibleExceptionWithAggregateOperator` ha cambiado de nombre a `RelationalEventId.LogQueryPossibleExceptionWithAggregateOperatorWarning`.
