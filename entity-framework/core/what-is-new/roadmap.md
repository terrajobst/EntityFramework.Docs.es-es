...
La segunda versión preliminar de EF Core 2.1 se ha publicado en abril de 2018. Ahora puede encontrar más información sobre esta versión en [Novedades de EF Core 2.1](xref:core/what-is-new/ef-core-2.1).
